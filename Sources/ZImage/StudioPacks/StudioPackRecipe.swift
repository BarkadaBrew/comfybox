// StudioPackRecipe.swift — Resolves a StudioPack into a concrete generation
// recipe against the locally available LoRA library.
//
...
/// against a subject and the local LoRA library.
...
public enum StudioPackResolver {
  ...
  public static func resolve(
    ...
    return StudioPackRecipe(
      packId: pack.id,
      prompt: pack.composePrompt(subject: subject),
