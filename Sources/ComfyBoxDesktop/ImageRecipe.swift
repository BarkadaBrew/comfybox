...
public struct ImageRecipe {
    ...
    public static func from(params: [String: Any]) -> ImageRecipe? {
        ...
        // Todd 2026-09-04: kroma is a regular LoRA — a `role: "kroma"` wire
        // entry reconstructs as a normal `PresetLoRA` like any other role,
        // never pulled out into a separate field.
