...
final class MCPParityPhase1ToolTests: XCTestCase {
  ...
  func testTotalToolCountIncludesGapSet() {
    XCTAssertEqual(MCPToolRegistry.tools.count, 71, "Expected 71 registered MCP tools after Phase 1 + Phase 3 + get_job + #273 + #447 + Director WP2c + the Creative Library")
  }
