...
final class MCPJobToolSchemaTests: XCTestCase {
  ...
  func testToolCountGrewByExactlyOne() {
    XCTAssertEqual(
      MCPToolRegistry.tools.count, 59,
      "55 tools + get_job (#289) + nearline_anchor (#273) + set/get_admission_mode (#447). Update this pin and the two other pins in the same review.")
  }
}
